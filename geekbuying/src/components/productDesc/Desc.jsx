            ...
            <div className="subMain">
                ...
                <div className="rightMain">
                    ...
                    <div className='forSpans'>
                        ...
                        <span>Item Code: <span>{obj.itemCode || 345617}</span>
                        </span>
                    </div>
                    <div className='timer'>
                    ...
                    <div className="data">
                        <div className="price">
                            <span className='label'>Price:</span><span className='price1'>&#8377;{data.price}</span><span className='price2'><s>&#8377;{data.strikedoffprice}</s></span><span className="price3">{randomOff()}OFF</span>
                        </div>
