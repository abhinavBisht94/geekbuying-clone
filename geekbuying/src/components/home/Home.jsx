      ...
      <div className='second-div'>
        ...
        <div className='four-div'>
          <div className='four-div-block'>
              <p style={{textAlign:"center",fontSize:"14px",fontWeight:"500"}}>3D Printers & Laser Engravers</p>
          ...
          <div className='four-div-block'>
              <p style={{textAlign:"center",fontSize:"14px",fontWeight:"500"}}>Gamesir Brand Sale</p>
          ...
          <div className='four-div-block'>
              <p style={{textAlign:"center",fontSize:"14px",fontWeight:"500"}}>E-Bikes</p>
          ...
          <div className='four-div-block'>
              <p style={{textAlign:"center",fontSize:"14px",fontWeight:"500"}}>Xming 1080p Projector</p>
